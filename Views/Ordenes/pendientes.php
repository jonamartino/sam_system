...
<ol class="breadcrumb mb-4">
  <li class="breadcrumb-item active" aria-current="page">Tareas Pendientes Ordenes</li>
</ol>
<div class="table-responsive-xl table-fixed text-nowrap">
  <table class="table table-light table-hover w-100" data-order='[[ 0, "desc" ]]' data-page-length='25' id="tblOrdenesPendientes">
  <caption>Lista de ordenes de mantenimiento pendientes de acción.</caption>
